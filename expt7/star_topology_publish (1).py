...
while True:
    ...
    # MQTT_MSG = json.dumps({"data" : {"temperature" : values[0], "humidity" : values[1]}, "headers": {"source" : "Group-15-A", "destination" : "Group-11-A"}})
    MQTT_MSG = json.dumps({"data" : {"temperature" : values[0], "humidity" : values[1]}, "headers": {"source" : "Group-15-A", "destination" : "Group-15-B"}})
